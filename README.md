...
A full-stack web application designed to manage student records efficiently. Built with a focus on modern Java development and cloud-native architecture.
...
- **Frontend:** Thymeleaf
- **Database:** MySQL (Cloud-managed via **Aiven**)
- **DevOps:** Docker, Render, GitHub

## ✨ Key Features
- **Full CRUD Operations:** Create, Read, Update, and Delete student profiles.
- **Cloud Persistence:** Securely stores data in a remote MySQL instance.
...
---
*Created by Toka Akhil as a showcase of Full-Stack Java Development.*
